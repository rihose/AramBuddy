...
namespace AramBuddy.MainCore.Logics
{
    internal class Pathing
    {
        ...
        {  
            ...
            if (Player.Instance.IsZombie())
            {
                ...
                if (ObjectsManager.NearestEnemyMinion != null)
                {
                    ...
                    Position = ObjectsManager.AllyMinion.PredictPosition();
                    return;
                }
            }
        ...
        public static bool MeleeLogic()
        {
            ...
            {
                Program.Moveto = "NearestAllyMinion";
                Position = ObjectsManager.NearestAllyMinion.PredictPosition().Random();
                return true;
            }
        ...
        public static bool RangedLogic()
        {
            ...
            {
                Program.Moveto = "NearestEnemy";
                Position = NearestEnemy.PredictPosition().Extend(ObjectsManager.AllySpawn.Position.Random(), KiteDistance(NearestEnemyMinion)).To3D();
                return true;
            }
            ...
            {
                Program.Moveto = "NearestAlly";
                Position = ObjectsManager.NearestAlly.PredictPosition().Extend(ObjectsManager.AllySpawn, 100).Random();
                return true;
            }
